    ...
    with open(csv_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            Voter.objects.create(
                ...
                v20state=row['v20state'].strip().lower() == 'x',
                v21town=row['v21town'].strip().lower() == 'x',
                v21primary=row['v21primary'].strip().lower() == 'x',
                v22general=row['v22general'].strip().lower() == 'x',
                v23town=row['v23town'].strip().lower() == 'x',
