...
from .views import AddFriendView, ShowAllProfileView, ShowFriendSuggestionsView, ShowNewsFeedView, ShowProfilePageView, CreateProfileView, CreateStatusMessageView, UpdateProfileView, DeleteStatusMessageView, UpdateStatusMessageView, LogoutConfirmationView # Import both views
...
urlpatterns = [
    ...
    path('profile/my/', ShowProfilePageView.as_view(), name='my_profile'),
